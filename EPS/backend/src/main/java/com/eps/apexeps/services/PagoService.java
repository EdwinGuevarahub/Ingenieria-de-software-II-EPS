...
public class PagoService {
     ...
     */
    public List<PagoDTO> listarPagos(Long pacienteId, LocalDateTime desde, LocalDateTime hasta, int page, int size) {
        ...
        return agendas.subList(fromIndex, toIndex).stream()
            .map(agenda -> new PagoDTO(
                ...
                agenda.getFecha().atZone(ZoneId.systemDefault()).toLocalDateTime(),
                agenda.getFechaPago() != null ? agenda.getFechaPago().atZone(ZoneId.systemDefault()).toLocalDateTime() : null,
                agenda.getEstado()
            ))
     ...
     */
    public List<PagoDTO> listarPagos(Long pacienteId, LocalDateTime desde, LocalDateTime hasta) {
    ...
    public AgendaPagoDTO registrarPago(Long pacienteId, PagoAgendaDTO dto) {
        ...
        return new AgendaPagoDTO(
            ...
            actualizado.getFechaPago().atZone(ZoneId.systemDefault()).toLocalDateTime(),
