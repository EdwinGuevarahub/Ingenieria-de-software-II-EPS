...
const GestionAfiliado = () => {
  // Estilos globales para campos de entrada
  const inputStyles = { backgroundColor: 'white' };
    ...
    <Box sx={{ p: 3, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      ...
      <Card sx={{ maxWidth: 1200, margin: '0 auto' }}>
        <CardContent sx={{ p: 4 }}>
          ...
          {/* Sección Administrador Registrador */}
          <Typography variant="h6" sx={{ mb: 3, fontWeight: 'bold', color: '#333' }}>
            Datos Administrador Registrador
          </Typography>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => handleInputChange('AdmRegistrador', 'email', e.target.value)}
                sx={inputStyles}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => handleInputChange('AdmRegistrador', 'nombre', e.target.value)}
                sx={inputStyles}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => handleInputChange('AdmRegistrador', 'password', e.target.value)}
                sx={inputStyles}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => handleInputChange('AdmRegistrador', 'telefono', e.target.value)}
                sx={inputStyles}
              />
            </Grid>
          </Grid>
